...
<?php if($footer_copyright_enabled): ?>
	<?php $footer_copyright_text = stm_dynamic_string_translation('Footer Copyright', get_theme_mod('footer_copyright_text', '&copy; 2020 <a href="http://motors.stylemixthemes.com/landing">Motors - Car Dealer WordPress Theme</a><span class="divider"></span>Trademarks and brands are the property of their respective owners.')); ?>
	<?php if(stm_is_boats()): ?>
