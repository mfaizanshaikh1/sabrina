<?php
	...
	$default_down_payment_type    = get_theme_mod('default_down_payment_type', '');
	$default_down_payment_percent = get_theme_mod('default_down_payment_percent', '');

	if( $default_down_payment_type == 'percent'){
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-group">
				<div class="labeled"><?php esc_html_e("Vehicle price",'motors');?> <span class="orange">(<?php echo stm_do_lmth($currency_symbol); ?>)</span></div>
			...
			<!--Down Payment-->
			<div class="form-group">
				<div class="labeled"><?php esc_html_e("Down Payment",'motors');?> <span class="orange">(<?php echo stm_do_lmth($currency_symbol); ?>)</span></div>
