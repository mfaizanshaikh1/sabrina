...
<?php else:
    ...
    $addToCompare = (stm_is_aircrafts()) ? esc_html__('Add to compare', 'motors') : esc_html__('Add car to compare', 'motors');
            ...
            if ($compares->have_posts()): ?>
                <div class="row row-4 car-listing-row stm-car-compare-row">
                    <div class="col-md-3 col-sm-3 hidden-xs">
                        <h2 class="compare-title"><?php echo (stm_is_aircrafts()) ? esc_html__('Compare', 'motors') : esc_html__('Compare Vehicles', 'motors'); ?></h2>
                    ...
                    <?php for ($i = 0; $i < $empty_cars; $i++) { ?>
                        <div class="col-md-3 col-sm-3 compare-col-stm-empty">
                            <a href="<?php echo esc_url(stm_get_listing_archive_link()); ?>">
                                ...
                                <div class="h5"><?php echo stm_do_lmth($addToCompare); ?></div>
                            </a>
                        </div>
                    <?php } ?>
                </div> <!--row-->
