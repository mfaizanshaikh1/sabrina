...
$showCart = get_theme_mod( 'header_cart_show', false );
        ...
        <div class="container">
            ...
            <div class="header-help-bar">
                <ul>
                    ...
                    <?php if ( $showCart && !empty( $woocommerce_shop_page_id ) && !is_listing() ): ?>
                    ...
                    <?php if ( is_listing() && stm_get_header_layout() == 'car_dealer' ) : ?>
                        ...
                        <?php endif; ?>
                        <?php if(get_theme_mod('header_show_profile', false)) : ?>
                            <li>
                    ...
                    <?php if(get_theme_mod('hma_search_button', true)): ?>
                        <li class="nav-search">
