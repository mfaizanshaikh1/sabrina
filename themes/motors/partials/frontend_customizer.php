        ...
        <div class="stm_customizer_element stm_visible">
            ...
            <div class="customizer_element">
                <select name="stm-select-layout">
                    <option value="http://motors.stylemixthemes.com/" <?php if ( stm_is_car_dealer() ) echo "selected" ?>>
                        Car Dealership One
                    </option>
                    <option value="http://motors.stylemixthemes.com/dealer-two" <?php if ( stm_is_dealer_two() ) echo "selected" ?>>
                        Car Dealership Two
                    </option>
                    <option value="http://motors.stylemixthemes.com/classified" <?php if ( stm_is_listing() ) echo "selected" ?>>
                        Classified Listing
                    </option>
                    <option value="http://motors.stylemixthemes.com/classified-two" <?php if ( stm_is_listing_two() ) echo "selected" ?>>
                        Classified Listing Two
                    </option>
                    <option value="http://motors.stylemixthemes.com/classified-three" <?php if ( stm_is_listing_three() ) echo "selected" ?>>
                        Classified Listing Three
                    </option>
                    <option value="http://motors.stylemixthemes.com/classified-four" <?php if ( stm_is_listing_four() ) echo "selected" ?>>
                        Classified Listing Four
                    </option>
                    <option value="http://motors.stylemixthemes.com/car-repair-service" <?php if ( stm_is_service() ) echo "selected" ?>>
                        Car Repair Service
                    </option>
                    <option value="http://motors.stylemixthemes.com/boats" <?php if ( stm_is_boats() ) echo "selected" ?>>
                        Boats Dealership
                    </option>
                    <option value="http://motors.stylemixthemes.com/motorcycles" <?php if ( stm_is_motorcycle() ) echo "selected" ?>>
                        Motorcycles
                    </option>
                    <option value="http://motors.stylemixthemes.com/rent-a-car" <?php if ( stm_is_rental() ) echo "selected" ?>>
                        Rent a car
                    </option>
                    <option value="http://motors.stylemixthemes.com/magazine" <?php if ( stm_is_magazine() ) echo "selected" ?>>
                        Car Magazine
                    </option>
                    <option value="http://motors.stylemixthemes.com/auto-parts" <?php if ( stm_is_auto_parts() ) echo "selected" ?>>
                        Auto Parts Shop
                    </option>
                </select>
            </div>
        ...
        $("#skin_color span").on('click', function () {
            ...
            if (style_id != 'site_style_default') {
                ...
                <?php if(!stm_is_listing_four()): ?>
                    $("head").append('<link rel="stylesheet" id="custom_style" href="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/css/<?php echo esc_attr( $boats_path ); ?>' + style_id + '.css?v=4" type="text/css" media="all">');
                    <?php if(!stm_is_boats()): ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    $("head").append('<link rel="stylesheet" id="custom_style" href="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/css/listing_four/<?php echo esc_attr( $boats_path ); ?>' + style_id + '.css?v=4" type="text/css" media="all">');
                <?php endif; ?>
