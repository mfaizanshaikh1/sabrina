            ...
            <li class="car-action-dealer-info">
                <div class="listing-archive-dealer-info clearfix">
                    ...
                    <div class="dealer-info-block <?php echo esc_attr($empty_user_info); ?>">
                        ...
                        <?php else: ?>
                            <div class="title"><span><?php esc_html_e('Private Seller', 'motors'); ?>: </span><a
                                    href="<?php echo esc_url(stm_get_author_link($user->data->ID)); ?>"><?php echo esc_attr(stm_display_user_name($user->ID)); ?></a>
                            </div>
                        <?php endif; ?>
                        <?php $showNumber = (stm_is_aircrafts()) ? true : get_theme_mod("stm_show_number", false); ?>
                            <div class="dealer-information">
								<?php if (!empty($user_phone)): ?>
									...
									<?php else : ?>
										...
										<span class="stm-show-number" data-id="<?php echo esc_attr($user->ID); ?>"><?php echo esc_html__("Show number", "motors"); ?></span>
									<?php endif; ?>
								<?php endif; ?>
                                <?php /*
