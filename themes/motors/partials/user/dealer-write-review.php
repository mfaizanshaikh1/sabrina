        ...
        <div class="stm-write-dealer-review clearfix">
            <div class="left">
                <div class="form-group">
                    ...
                    <input type="text" name="stm_title"
                           placeholder="<?php esc_attr_e( 'Example: Great Service, clean facilities, etc', 'motors' ) ?>"
                           required/>
                </div>
                <div class="form-group">
                    <h4><?php esc_html_e( 'Your Review', 'motors' ); ?></h4>
                    <textarea name="stm_content"
                              placeholder="<?php esc_attr_e( 'Enter Your Review', 'motors' ) ?>"></textarea>
                </div>
                ...
                <a href="#"
                   class="dp-in button disabled hidden-xs"><?php esc_html_e( 'Submit review', 'motors' ); ?></a>
...
<?php else: ?>
    ...
    <h4 class="stm-login-review-leave"><a
                href="<?php echo esc_url( stm_get_author_link() ); ?>"><?php esc_html_e( 'Login', 'motors' ); ?></a> <?php esc_html_e( 'to leave a review', 'motors' ); ?>
    </h4>
