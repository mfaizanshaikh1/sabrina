        ...
        <div class="stm-rent-fields-wrap">
            ...
            <div class="stm-rent-text-wrap">
                ...
                <input type="text" class="input-text" name="username" id="username"
                       ...
                       placeholder="<?php esc_attr_e( 'Username or email address', 'motors' ); ?> *"/>
                <?php if ( stm_is_rental() ) : ?>
            </div>
        <?php endif; ?>
            </p>
            <p class="form-row form-row-wide <?php if ( stm_is_rental() ) echo "stm-rent-pass"; ?>">
                ...
                <a class="lost_password"
                   href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'motors' ); ?></a>
            <div class="stm-rent-pass-wrap">
                <?php endif ?>
                <input class="input-text" type="password" name="password" id="password"
                       placeholder="<?php esc_attr_e( 'Password', 'motors' ); ?> *"/>
                <?php if ( stm_is_rental() ): ?>
            </div>
        <?php endif; ?>
            </p>
            ...
            <?php if ( !stm_is_auto_parts() ) : ?>
                ...
                <label for="rememberme" class="inline">
                    <input name="rememberme" type="checkbox" id="rememberme"
                           value="forever"/> <?php _e( 'Remember me', 'motors' ); ?>
                </label>
                </p>
                <?php if ( !stm_is_rental() ): ?>
            ...
            <form method="post" class="register">
                ...
                <?php endif; ?>
                    ...
                    <div style="<?php echo( ( is_rtl() ) ? 'right' : 'left' ); ?>: -999em; position: absolute;"><label
                                for="trap"><?php esc_html_e( 'Anti-spam', 'motors' ); ?></label><input type="text"
                                                                                                       name="email_2"
                                                                                                       id="trap"
                                                                                                       tabindex="-1"/>
                    </div>
