		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						'title_reply'          => have_comments() ? __( 'Add a review', 'motors' ) : sprintf( __( 'Be the first to review &ldquo;%s&rdquo;', 'motors' ), get_the_title() ),
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
					    ...
					    $label = (stm_is_auto_parts()) ? '<label for="rating">' . esc_html__( 'Your rating:', 'motors' ) . '</label>' : '';
