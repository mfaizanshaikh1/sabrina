			...
			<div class="stm-admin-row">
				...
				<div class="stm-admin-one-half">
					<div class="stm-admin-one-half-inner">
						...
						<p>
							<?php printf(__( 'Our online documentation is a useful resource for learning the every aspect and features of %s.', 'motors' ), $theme_name); ?>
						</p>
						<a href="https://docs.stylemixthemes.com/motors-theme-documentation/" target="_blank">
