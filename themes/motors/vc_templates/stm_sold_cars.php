<div class="archive-listing-page">
    <div class="container">
        <div class="row">
            <?php $filter = stm_listings_filter(['sold_car' => 'on']); ?>
            ...
            <div class="col-md-3 col-sm-12 classic-filter-row sidebar-sm-mg-bt <?php echo esc_attr($sidebar_pos['sidebar']); ?>">
                <?php stm_listings_load_template('classified/filter/sidebar', array('filter' => $filter,'action' => 'listings-sold')); ?>
                <!--Sidebar-->
            ...
            <div class="col-md-9 col-sm-12 <?php echo esc_attr($sidebar_pos['content']); ?>">
                <div class="stm-ajax-row">
                    ...
                    <div id="listings-result" data-type="sold-car">
                        <?php stm_listings_load_results(['sold_car' => 'on'], 'sold_car'); ?>
                    </div>
                </div>
            </div> <!--col-md-9-->
