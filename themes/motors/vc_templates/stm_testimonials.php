...
$scAtts['style_view'] = (!empty($scAtts['style_view'])) ? $scAtts['style_view'] : '';

?>

<div class="testimonials-carousel-wrapper <?php if(!is_null($scAtts)) echo esc_attr($scAtts['style_view']); ?>">
