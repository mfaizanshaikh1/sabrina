...
$recentPostsMagazn  = wp_create_nonce( 'stm_ajax_get_recent_posts_magazine' );
$ajaxUrl ='&posts_per_page=' . $number_of_posts . '&action=stm_ajax_get_recent_posts_magazine&security=' . $recentPostsMagazn;

?>

<div id="stm_widget_recent_news" data-action="<?php echo esc_attr($ajaxUrl); ?>" class="stm_widget_recent_news" >
