...
<div class="<?php echo esc_attr($fullwidth_class_outer); ?>">
    <div
        class="stm-carousel owl-carousel <?php echo esc_attr($image_gallery); ?> <?php echo esc_attr($css_class); ?> <?php echo esc_attr($fullwidth_class); ?>">
                ...
                <div class="media-carousel-item">
                    ...
                    <a class="stm_fancybox" href="<?php echo esc_attr($fancy_link); ?>"
                       ...
                       rel="<?php echo esc_attr($image_gallery); ?>">
                        <?php echo stm_do_lmth($thumbnail); ?>
                    </a>
                </div>
