	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-group">
				<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Vehicle price",'motors');?> <span class="orange">(<?php echo stm_do_lmth($currency_symbol); ?>)</span></div>
			...
			<!--Down Payment-->
			<div class="form-group">
				<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Down Payment",'motors');?> <span class="orange">(<?php echo esc_html($currency_symbol); ?>)</span></div>
