							...
							if (!empty($recaptcha_enabled) and $recaptcha_enabled and !empty($recaptcha_public_key) and !empty($recaptcha_secret_key)):
                                ...
                                <script>
                                    function onSubmit(token) {
                                        document.getElementById("trade-in-default").trigger('submit');
                                    }
                                </script>
						...
						<div class="clearfix">
							...
							<div class="pull-left">
								...
								if (!empty($recaptcha_enabled) and $recaptcha_enabled and !empty($recaptcha_public_key) and !empty($recaptcha_secret_key)): ?>
                                    <script>
                                        function onSubmit(token) {
                                            document.getElementById("trade-in-motorcycles").trigger('submit');
                                        }
                                    </script>
						...
						<div class="clearfix">
							...
							<div class="pull-left">
								...
								if (!empty($recaptcha_enabled) and $recaptcha_enabled and !empty($recaptcha_public_key) and !empty($recaptcha_secret_key)):
                                    ...
                                    <script>
                                        function onSubmit(token) {
                                            document.getElementById("trade-in-boats").trigger('submit');
                                        }
                                    </script>
                                    <input class="g-recaptcha" data-sitekey="<?php echo esc_attr($recaptcha_public_key); ?>" data-callback='onSubmit' type="submit" value="<?php esc_html_e('Save and finish', 'motors'); ?>" />
								<?php else: ?>
