...
stm_motors_enqueue_scripts_styles('stm_popular_makes');
...
$tax = (!empty($taxonomy)) ? trim( $taxonomy[0] ) : 'make';
                    ...
                    <a href="<?php echo esc_url( stm_get_listing_archive_link( array( $term->taxonomy => $term->slug ), '' ) ); ?>" class="stm_listing_popular_makes_single"
                       title="<?php echo esc_attr($term->name); ?>">
                        <div class="inner">
                            ...
                            <div class="name heading-font"><?php echo esc_attr($term->name); ?> <span class="count">(<?php echo esc_html($term->count); ?>)</span></div>
                        </div>
                    </a>
                <?php else: continue; ?>
                <?php endif; ?>
