	...
	<div class="clearfix">
		<div class="call-to-action-content pull-left">
			<?php if(!empty($call_to_action_label)): ?>
				<div class="content" <?php if(!empty($call_to_action_text_color)) echo 'style="color: ' . $call_to_action_text_color . '"'; ?>>
		...
		<div class="call-to-action-right" <?php if(!empty($call_to_action_text_color)) echo 'style="color: ' . $call_to_action_text_color . '"'; ?>>
			...
			<div class="call-to-action-meta" <?php if(!empty($call_to_action_text_color)) echo 'style="color: ' . $call_to_action_text_color . '"'; ?>>
