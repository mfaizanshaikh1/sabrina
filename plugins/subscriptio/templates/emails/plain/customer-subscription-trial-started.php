 ...
 *
 * This template can be overridden by copying it to yourtheme/subscriptio/emails/plain/customer-subscription-trial-started.php
 *
...
echo sprintf(esc_html__('Your %s subscription trial has started. Here are the details of this subscription:', 'subscriptio'), esc_html(get_bloginfo('name', 'display'))) . "\n\n";
