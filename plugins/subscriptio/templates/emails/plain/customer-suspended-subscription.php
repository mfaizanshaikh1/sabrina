...
echo sprintf(esc_html__('Your subscription with %1$s has been suspended and is set to be cancelled on %2$s in case of no payment. Here are the details of this subscription:', 'subscriptio'), esc_html(get_bloginfo('name', 'display')), $next_action_date) . "\n\n";
