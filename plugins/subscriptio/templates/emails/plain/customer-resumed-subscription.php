...
/**
 * Customer Resumed Subscription Email Template
 *
 * This template can be overridden by copying it to yourtheme/subscriptio/emails/plain/customer-resumed-subscription.php
 *
...
echo sprintf(esc_html__('Your subscription with %s has been resumed. Here are the details of this subscription:', 'subscriptio'), esc_html(get_bloginfo('name', 'display'))) . "\n\n";
