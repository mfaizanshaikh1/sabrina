 ...
 *
 * This template can be overridden by copying it to yourtheme/subscriptio/emails/customer-activated-subscription.php
 *
...
<p><?php printf(esc_html__('Your subscription with %s has been activated. Here are the details of this subscription:', 'subscriptio'), esc_html(get_bloginfo('name', 'display'))); ?></p>
