 ...
 *
 * This template can be overridden by copying it to yourtheme/subscriptio/emails/customer-subscription-set-to-cancel.php
 *
...
<p><?php printf(esc_html__('Your subscription with %1$s is now set to cancel on %2$s. Here are the details of this subscription:', 'subscriptio'), esc_html(get_bloginfo('name', 'display')), $next_action_date); ?></p>
