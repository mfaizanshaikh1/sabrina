 ...
 *
 * This template can be overridden by copying it to yourtheme/subscriptio/emails/customer-reactivated-subscription.php
 *
...
<p><?php printf(esc_html__('Your subscription with %s has been reactivated. Here are the details of this subscription:', 'subscriptio'), esc_html(get_bloginfo('name', 'display'))); ?></p>
