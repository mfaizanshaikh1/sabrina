...
= 1.5.4 =
Resolved some internal issue

= 1.5.5 =
Premium Features -  Now arrage your posts in Ascending/ Descending order in just one click
...
= 1.5.6 =
Now more secure from hackers,  Please backup your database before upgrade, it can delete your all orders, download pluging in seperated directory and replace only plugin file.

= 1.5.7 =
Tested with Wordpress 4.5.3, Please backup your db before update

= 1.5.8 =
Blank row issue fixed.
