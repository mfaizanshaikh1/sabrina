(function($) {
	...
	$(document).ready(function ($) {
		...
		if($('body').find('.stm-automanager-xml').length > 0) {
		...
		$('#stm_automanager_first_step').on("submit", function(event){
            ...
            $.ajax({
                ...
                dataType: 'json',
                context: this,
                data: $( this ).serialize() + '&action=stm_ajax_file_automanager_upload&security=' + fileAutomanagerUpload,
                beforeSend: function(){
        ...
        $('.stm-proceed-step-three').on('click',function(e){
	        e.preventDefault();
	        $.ajax({
                url: ajaxurl,
                type: "POST",
                dataType: 'json',
                context: this,
                data: $('#stm_automanager_second_step').serialize() + '&action=stm_ajax_automanager_save_associations&security=' + amSaveAssociations,
                beforeSend: function(){
        ...
        $('.stm-proceed-step-four').on('click',function(e){
	        e.preventDefault();
	        $.ajax({
                url: ajaxurl,
                type: "POST",
                dataType: 'json',
                context: this,
                data: $('#stm_automanager_third_step').serialize() + '&action=stm_ajax_automanager_save_template&security=' + amSaveTemplate,
                beforeSend: function(){
        ...
        $('.update_now_test').on('click',function(e){
	        e.preventDefault();
	        $('#stm_automanager_fourth_step iframe').attr('src', window.location.href + '&stm_xml_do_import_automanager=1');
        })
